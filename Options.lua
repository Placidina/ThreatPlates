          ...
          args = {
                ...
                Situational = {
                  ...
                  args = {
                    ...
                    MarkedEnabled = {
                      ...
                      type = "toggle",
                      order = 10,
                      arg = { "threat", "scale", "situational", "markedEnabled" },
                    },
                    MarkedUnit = GetScaleEntryDefault(11, { "threat", "scale", "situational", "markedUnit" }),
                    MouseoverEnabled = {
                      name = L["Mouseover"],
                      order = 20,
                      type = "toggle",
                      arg = { "threat", "scale", "situational", "mouseoverEnabled" },
                    },
                    MouseoverUnit = GetScaleEntryDefault(21, { "threat", "scale", "situational", "mouseoverUnit" }),
                    CastingEnemyEnabled = {
                      name = L["Enemy Casting"],
                      order = 30,
                      type = "toggle",
                      arg = { "threat", "scale", "situational", "castingEnemyEnabled" },
                    },
                    CastingEnemyUnit = GetScaleEntryDefault(31, { "threat", "scale", "situational", "castingEnemyUnit" }),
                  },
                },
                Marked = {
            ...
            Coloring = {
              ...
              args = {
                ...
                Situational = {
                  name = L["Situational Coloring Healthbar"],
                  type = "group",
                  order = 4,
                  inline = true,
                  args = {
                    MouseoverEnabled = {
                      ...
                      get = GetValue,
                      set = SetValue,
                      arg = { "threat", "coloring", "healthbar", "situational", "mouseoverEnabled" },
                    },
                    MouseoverColor = {
                      name = L["Color"],
                      type = "color",
                      order = 11,
                      arg = { "threat", "coloring", "healthbar", "situational", "mouseoverColor" },
                      hasAlpha = true,
                    },
                    CastingEnemyEnabled = {
                      name = L["Enemy Casting"],
                      ...
                      get = GetValue,
                      set = SetValue,
                      arg = { "threat", "coloring", "healthbar", "situational", "castingEnemyEnabled" },
                    },
                    CastingEnemyColor = {
                      name = L["Color"],
                      type = "color",
                      order = 21,
                      arg = { "threat", "coloring", "healthbar", "situational", "castingEnemyColor" },
                      hasAlpha = true,
                    },
                  },
                },
